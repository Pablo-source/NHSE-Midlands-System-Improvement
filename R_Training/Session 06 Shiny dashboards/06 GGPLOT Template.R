# R Script: 
# 06 GGPLOT Template.R

# This is a practical example on how to create line charts and bar charts using ggplot2

# GGPLOT2 line chart template
# PLOT01  <- line_plot_data %>% 
#   ggplot(aes(x = DATE, y = Adm_allpath,colour=Adm_allpath)) +
#   geom_line() +

# GGPLOT2 bar chart template
...
server <- function(input,output) {
  ...
  # OUTPUT 06 "Bar plot"
  # RTTT Admitted patients within 18 weeks from 1st January 2016 on wards
